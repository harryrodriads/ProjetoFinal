...
public class InternacaoController {
	...
	@PostMapping("/salvar")
	public String salvarInternacaoWeb(@Valid @ModelAttribute("internacao") Internacao internacao, BindingResult result,
			Model model) {
		if (result.hasErrors()) {
		...
		model.addAttribute("successMessage",
				isEdicao ? "Internação atualizada com sucesso!" : "Internação cadastrada com sucesso!");
	...
	public class InternacoesApiController {
		...
		@ResponseBody
		public ResponseEntity<?> cadastrarInternacaoApi(@Valid @RequestBody Internacao internacao,
		...
		@ResponseBody
		public ResponseEntity<?> editarInternacaoApi(@PathVariable Long id, @Valid @RequestBody Internacao internacao,
				BindingResult result) {
			if (result.hasErrors()) {
				return ResponseEntity.badRequest().body("Erro de validação: " + result.getAllErrors());
			}
